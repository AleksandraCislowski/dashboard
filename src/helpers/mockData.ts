  ...
  datasets: [
    {
      ...
      data: [11, 16, 7, 3, 14],
      backgroundColor: [
        withOpacity(chartPalette.navy, 0.82),
        withOpacity(chartPalette.teal, 0.82),
        withOpacity(chartPalette.amber, 0.84),
        withOpacity(chartPalette.slate, 0.82),
        withOpacity(chartPalette.coral, 0.82),
      ],
      borderWidth: 0,
    },
  ],
