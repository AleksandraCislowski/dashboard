...
Good screens to capture for a portfolio case study:

- Dashboard overview hero and KPI section
- Revenue trend with supporting metric cards
- Order Intelligence workspace with filters and watchlist
- Account settings screen
- Workspace preferences screen

Short project framing:

> Northstar Commerce is an e-commerce operations dashboard designed to help
> teams monitor revenue, conversion, acquisition channels, customer health, and
> operational risk from one workspace.

Useful portfolio angles:

- Product framing: one place for daily storefront monitoring and follow-up
- UX framing: a flow from high-level signal to record-level investigation
- Visual framing: calmer data palette, stronger hierarchy, cleaner chart reading
- System framing: supporting account and preference views to make the product
  feel complete
...
Northstar Commerce is an e-commerce operations dashboard designed to help
teams monitor revenue, conversion, acquisition channels, customer health, and
order risk from one workspace.

### Portfolio Card Copy

Short version:

> Northstar Commerce is a product-style dashboard for e-commerce operations,
> combining KPI monitoring, trend analysis, and order-level investigation in a
> single workspace.

Longer version:

> Northstar Commerce is an e-commerce operations dashboard built around daily
> storefront monitoring. It brings top-line KPI visibility, channel and
> retention insights, and record-level order investigation into one interface,
> with supporting account and workspace settings that make the product feel
> complete.

## Suggested Captions

1. Overview dashboard for daily storefront monitoring
2. Revenue trend and supporting health signals
3. Order Intelligence workspace for record-level follow-up
4. Account settings designed as part of the product system
5. Workspace preferences for alerts, reporting, and visibility

## Interview Talking Points

- The project was framed around a specific operational user instead of generic dashboard visuals.
- The interface moves from top-line health checks to deeper operational investigation.
- Order Intelligence gives the product a stronger workflow than a standard demo table.
- Account and preference views were treated as part of the product system, not leftover template screens.
- Light and dark modes were tuned to keep chart-heavy views readable.
...
If you are showing the project in a portfolio, these are the strongest points
to emphasize:

- It is framed around a specific user and workflow instead of generic charts
- The homepage is designed for fast daily check-ins and quick signal reading
- The analytics screen extends the product into a more operational workspace
- Supporting screens keep the product believable beyond the main dashboard
- Light and dark modes were tuned for cleaner chart readability
